...
-- Tarefas: cada tarefa pertence a um projeto E é atribuída a um usuário
-- (dois relacionamentos 1:N chegando na mesma tabela)
...
-- Consulta: tarefas de um projeto, com nome do usuário e status
SELECT
